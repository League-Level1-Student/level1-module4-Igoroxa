...
if (buttonPressed == firstButton) {
	askQuestion("How many countries are currently in Africa?" , "50" , 1000);
}
...
if (buttonPressed == secondButton) {
	askQuestion("How many continets are on Earth" , "7" , 100);
}
			// Call the askQuestion() method with a harder question
askQuestion("It is believed that the Earth is currently _______ years old" , "4 Billion" , 100);
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		String responce = JOptionPane.showInputDialog("What is the answer?");
		
		// Stop the theme music when they have entered their response. 
		
		// If the answer is correct
if (responce.equals(correctAnswer)) {
